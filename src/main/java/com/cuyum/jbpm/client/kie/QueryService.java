...
public class QueryService {
	...
	public Map<String, List<String>> createMap(List<Long> workItemId,
		...
		if (union != null) {
			newList = new ArrayList<String>();
			newList.add(union.toString());
			parameter.put("union", newList);
		} 
		// *********************************************************
	...
	public Map<String, Object> createTaskParam(String query) {
	...
	public Map<String, Object> getTaskParam(String[] params) {
